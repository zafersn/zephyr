 ...
 * Format: $PSEPU,<pos_3d>,<pos_2d>,<pos_lat>,<pos_lon>,<pos_alt>,<vel_3d>,<vel_2d>,<vel_hdg>,<vel_east>,<vel_north>,<vel_up>*<checksum>
 *
 * @param chat Modem chat instance
 * @param argv Array of parsed fields from NMEA sentence
 * @param argc Number of fields in argv
...
void gnss_publish_aux_data(const struct device *dev, const struct hl78xx_gnss_nmea_aux_data *aux_data,
			     uint16_t size);
